...
Implement `resolve(records, pairs, threshold)`, returning clusters — ids sorted within
each cluster, clusters sorted by their first id.
...
resolution tractable — you cannot score every pair in a million-record corpus — and every
