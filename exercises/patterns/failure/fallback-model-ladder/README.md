...
Falling from Opus to Sonnet costs 120, not 20, because the failed call was billed. A
cost report that only counts the model that answered will tell you fallbacks are free.
