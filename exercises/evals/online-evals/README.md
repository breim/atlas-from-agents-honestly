...
every turn, because the judge-cost arithmetic that caps golden sets applies with more force
to unbounded traffic. So online scoring is stratified sampling, and the stratification is
where the value is. A flat 20% sample would have looked at one escalation in five; this plan
looks at all of them, and
