...
improves resolution cannot claim a cost win it did not earn — the denominator moved — and a
release that quietly doubles escalations cannot hide behind a stable per-call figure.
