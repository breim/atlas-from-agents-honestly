...
optimisation list. Four turns cost 177,000 micros; eight cost 474,000, which is 2.68× the money
for 2× the work, because the whole transcript is re-sent every turn and input tokens grow with
