...
safety. It is the eleven-second average, and then it is [OWASP's
T10](https://genai.owasp.org/resource/owasp-top-10-for-agentic-applications-for-2026/): flood
the reviewer with benign requests until rubber-stamping is the habit, then insert the action
you actually wanted. The gate you built for safety has become a control that is worse than no
gate, because everyone believes there is oversight.
