...
cache, the trace or the eval set — every one of them introduced to solve a durability or quality
problem, by people thinking about neither authorization nor tenancy.
...
wrong-tenant resumption — and all of them depend on knowing the full list of stores.
